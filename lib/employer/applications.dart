...
class EmployerApplication extends StatefulWidget {
  const EmployerApplication({super.key});

  @override
  State<EmployerApplication> createState() => _EmployerApplicationState();
}

class _EmployerApplicationState extends State<EmployerApplication> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Row(
                          children: [
                           SizedBox(width: 30,),
                           Text('56 Applications',style: TextStyle(fontSize:12,fontWeight: FontWeight.bold,color:Color(0xFF095B66) ),)
                          ],
                        ),
                        Row(
                          children: [
